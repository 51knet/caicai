		...
		<div class="tabbable">
			...
			<div class="tab-content">
				...
				<div class="tab-pane <c:if test='${active == "psw"}'>active</c:if>" id="security_tab">
					...
					<form class="form-horizontal" action='<c:url value="/admin/changePsw"></c:url>' method="post" id="chanePsw_info_form">
				...
				<div class="tab-pane <c:if test='${active == "url"}'>active</c:if>" id="p_url_tab">
					<form class="form-horizontal" action='<c:url value="/admin/selfurl"></c:url>' method="post" id="selfurl_info_form">
				...
				<div class="tab-pane <c:if test='${active == "photo"}'>active</c:if>" id="photo_tab">
					<form class="form-horizontal" action='<c:url value="/admin/photo"></c:url>' method="post" id="photo_form">
...
$(document).ready(function(){
	...
	$("#oriPsw").blur(function(){
		...
		$.ajax({
			type:"post",
			url: '<c:url value="/pcenter/pswInfoCheck" />',
