...
<div class="row-fluid custom round">
	...
	<div class="content">	
		<div style="text-align: center; margin-bottom: 10px;">
				<table cellpadding="10"  style="" class="bb unReadMsg limitTable">
		  			  <tr>
		...
		<div style="text-align: center; margin-bottom: 10px;">
				<table cellpadding="10" width=100%  border=0 style="" class="bb unReadMsg limitTable">
		  			  <tr>
		...
		<div >
			<c:forEach items="${page.content}" var = "page" >
				<table cellpadding="10"  style="" class="bb unReadMsg limitTable" >
		  			  <tr>
					    <td rowspan="2" align="left" width="10%" valign="top"><a href='<c:url value="/admin/message/detail/${page.sendMsg.user.id}"></c:url>'><img src="<c:url value='${page.sendMsg.user.photo_url} '></c:url>" style="width:60px; height: 60px;"></a></td>
					  ...
					  <tr>
					    <td colspan="2" align="left" class="limitTd"><a href='<c:url value="/admin/message/detail/${page.sendMsg.user.id}"></c:url>'>${page.sendMsg.content}</a></td>
					  </tr>
		  		</table>
	  		</c:forEach>
