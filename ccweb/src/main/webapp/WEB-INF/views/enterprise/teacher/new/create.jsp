		...
		<div class="tabbable">
			<div class="tab-content">
						...
						<div style=" text-align: left;">
							...
							<form:form action="new/create" method="post" enctype="multipart/form-data" id="teacher_info_form" onsubmit="return checkTeacherPicture(this)">
								...
								<div class="control-group" id="content">
									...
									<div style="margin-left: 70px; margin-top: -20px;">
										<textarea id="KEcontent" name="content" rows="8" cols="5" style="width: 500px; height: 300px;"></textarea>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#teacher_info_form").submit(function(){
			teacherDescEditor.sync();
			return checkEmptyAjax("teacher_info_form","teacherInfoAJAX");
		});
