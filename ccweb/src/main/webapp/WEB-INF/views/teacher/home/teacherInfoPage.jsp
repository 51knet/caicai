	...
	<div class="tab-content">
		<div class="tab-pane active" id="personal_info">
			<form:form method="post">
				<input type="text" name="role" value="${sessionScope.sessionUserInfo.teacher.role }" placeholder="Role">
				<span class="help-block"><form:errors path="role"></form:errors></span>

				<input type="text" name="college" value="${sessionScope.sessionUserInfo.teacher.college }" placeholder="College">
				<span class="help-block"><form:errors path="college"></form:errors></span>

				<input type="text" name="major" value="${sessionScope.sessionUserInfo.teacher.major }" placeholder="Major">
