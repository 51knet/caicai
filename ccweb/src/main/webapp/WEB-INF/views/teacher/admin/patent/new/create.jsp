...
<div class="row-fluid custom round">
	...
	<div class="content">
		<form action= '<c:url value="/admin/patent/add"></c:url>'  method="post" name="anno_post" style="margin-left:50px;" >
			...
			<div class="control-group" id="inventer">
				<div class="controls">
					<i class="icon-star"></i> 发明人士：<input type="text" name="inventer"   placeholder="发明人士" > <span class="help-inline"><form:errors path="inventer" /></span>
				</div>
			</div>
			...
			<div class="control-group" id="agency">
				<div class="controls">
					<i class="icon-star"></i> 代理机构：<input type="text" name="agency"   placeholder="代理机构" > <span class="help-inline"><form:errors path="agency" /></span>
				</div>
			</div>
			
			<div class="control-group" id="agent">
				<div class="controls">
					<i class="icon-star"></i> 代理人士：<input type="text" name="agent"   placeholder="代理人士" > <span class="help-inline"><form:errors path="agent" /></span>
				</div>
			</div>
			...
			<div class="control-group" id="address">
				<div class="controls">
					<i class="icon-star"></i> 联系地址：<input type="text" name="address"   placeholder="申请地址" > <span class="help-inline"><form:errors path="address" /></span>
				</div>
			</div>
			
			<div class="control-group" id="summary">
				<div class="controls">
					<i class="icon-star"></i> 专利摘要：<br><textarea  name="summary"   placeholder="专利摘要" style="height: 80px; width: 320px;" > </textarea><span class="help-inline"><form:errors path="summary" /></span>
				</div>
			</div>

			<label style="clear: right;"></label>
			<button type="submit" class="btn btn-success">保存并发布</button>&nbsp;&nbsp;
			<a href='<c:url value="/admin/patent/preview"></c:url>' class="btn btn-success" target="blank">预览</a>&nbsp;&nbsp;
