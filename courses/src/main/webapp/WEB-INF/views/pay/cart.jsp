		...
		<table cellpadding="10" >
			<thead>
				<tr >
					...
					<th class="content" align="center" valign="bottom">融资率</th>
				</tr>
			</thead>
			<tbody>
				<tr class="bline">
					...
					<td  valign="top" class="myBlock"><fmt:formatNumber type="number" value="${projects.currentMoney/projects.totalMoney*100}" maxFractionDigits="0"/>%</td>
				</tr>
				<tr>
					<td colspan="4" align="right">
						<form  method="post" action='<c:url value="/projects/pay/view/${orderId}" ></c:url>'>
