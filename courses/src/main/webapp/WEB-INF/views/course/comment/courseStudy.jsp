...
<script type="text/javascript">
	...
	<div   style="margin-left:38px; margin-top: 10px; margin-bottom: 10px;">
		...
		<!-- <div id="course_${i.count}" onclick="javascript:courseOnclick(this);" style="margin-bottom: 30px;">
				<div style="font-size: 16px;"><b>第${course.key}课时</b></div>
				<c:forEach var="fileNames" items="${course.value}">
					<div class="fileName_${i.count}" style="margin-bottom: 10px;" >
