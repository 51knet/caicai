 	...
 	<div class="user_info_div">
 		<div style="margin: 20px 0px 0px 10px; float: left;">
 	 	...
 	 	<div class="user_info points">
 			...
 			<div style="width: 80px; float: left; margin: 10px 10px">
 				<table  cellpadding="5">
 					<tr style="background-color: #6797c8; color: #fff; font-weight: bold;"><td align="center">已融资金</td></tr>
 					<tr style="background-color: #fff; color: #6797c8; font-weight: bold;"><td align="center"><span>${projects.currentMoney } 万</span></td></tr>
 				</table>
 			</div>
 	 	</div>
 	</div>
