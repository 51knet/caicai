...
<div class="container marketing">
  <div class="container title">
		...
		<div class="rightTitle dropdown" >
			...
			<div class="dropdown-menu" style="text-align: left; width: 515px;" role="menu" aria-labelledby="dropdownMenu">
					<table style="width:100%; margin-left: 20px;" cellpadding="0" >
		...
		<div class="contentRight">
			...
			<div class="rigntBottom">
				...
				<c:forEach items="${activityList }" var="activityList" begin="0"  end="6">
					<li  ><div id="contentlimit" style="width:250px; float: left;" class="bLine_dash">
					...
					<table  width="100%" cellpadding="3" border="0">
						<tbody>
							<c:forEach items="${patentRequire }" var="patentRequire"  begin="0" step="2" end="16">
								<tr >
									<td><div id="contentlimit" style="width:350px; float: left;">
	     	     		...
	     	     		<table  width="100%" cellpadding="3" border="0">					
							<tbody>
								<c:forEach items="${patentRequire }" var="patentRequire"  begin="1" step="2" end="17">
									<tr >
										<td>
										<div id="contentlimit" style="width:350px; float: left;">
											<a class="a_color_ccc"  href="<c:url value="/requirement/view/${ patentRequire.id}"></c:url>"><img src="<c:url value='/resources/img/default/icon.png'></c:url>" >  ${patentRequire.title }</a>
										</div></td>									
									</tr>
								</c:forEach>
								<tr>
									<td colspan="3" align="right">
											<a class="a_color_green"  style="text-decoration: none;" href="<c:url value="/requirement/patent/list"></c:url>" >更多>></a>
									</td>
								</tr>
							</tbody>
						</table>
     	     		...
     	     		<div  class="span6"  >
						...
						<tbody>
							<c:forEach items="${technologyRequire }" var="technologyRequire"  begin="1" step="2" end="17">
								...
								<tr >
									<td colspan="3" align="right">
											<a class="a_color_green" style="text-decoration: none;" href="<c:url value="/requirement/technology/list"></c:url>" >更多>></a>
									</td>
								</tr>
						</tbody>
						</table>
