package com.knet51.diplomat.util.mailSender;
...
public class MailSender {
	...
	public boolean SendMail(String sendToAddress, String url) {
		...
		String context = "<div>亲爱的注册用户，您好：</div><div>欢迎您注册本网站，" +
				"请您点击下面链接来激活您的保密邮箱:</div>";
	...
	public boolean SendFocusMail(String sendToAddress, String url,Long fansid){
		MailSenderInfo mailInfo = new MailSenderInfo();
		String context = "<div>亲爱的注册用户，您好：</div><div>您有新的粉丝关注您了，" +
				"请您点击下面链接来查看:</div>";
