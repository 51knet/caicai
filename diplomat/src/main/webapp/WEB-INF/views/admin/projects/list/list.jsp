...
<div class="row-fluid custom round">
	...
	<div class="content">
		...
		<table class=" <c:if test="${sessionUserInfo.role == 'teacher'}">green</c:if> <c:if test="${sessionUserInfo.role == 'user'}">blue</c:if>" id="mytab" cellpadding="4" width=100%  border=0>
			<thead>
				<tr><th width="10%">LOGO</th><th width="20%">项目标题</th><th  width="15%">申请日</th><th width="12%">操作</th></tr>
			</thead>
			<tbody>
...
<div class="modal hide fade" id="destoryProjectsPostModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-footer">
	    ...
	    <form action='<c:url value="/admin/projects/delete"></c:url>' method="post" style="display: inline-block;" >
	    	<input id="p_delete_id" type="hidden" name="project_id" />
...
$(document).ready(function() {
	$('.destoryProjectsPostBtn').on('click', function() {
