...
<div class="row-fluid custom round">
	...
	<div class="content">
		<div style="text-align: right;">
			<a href='<c:url value="/admin/incubator/announcement/add"></c:url>' style="margin-bottom: 10px; font-size: 14px;"class="btn">
				添加新闻</a><br>
					...
					<c:forEach items="${page.content}" var="page">
						<tr>
							...
							<td align="center">
								 ...
								 <a href='<c:url value="/admin/incubator/announcement/edit/${page.id}"></c:url>'>修改</a>	
							</td>
						</tr>
					</c:forEach>
				</tbody>
...
<div class="modal hide fade" id="deleteAnnoPostModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-footer">
	    ...
	    <form action='<c:url value="/admin/incubator/announcement/destory"></c:url>' method="post" style="display: inline-block;" >
