...
<div class="row-fluid custom round">
	...
	<div class="content">
		<div style="text-align: right;">
			<a href='<c:url value="/admin/allies/announcement/add"></c:url>' style="margin-bottom: 10px; font-size: 14px;"class="btn">
				添加新闻</a><br>
			<table class="blue" id="mytab" cellpadding="7" width=100%  border=0>
				<thead><tr>
						<th  align="center">新闻图片</th>
					...
					<c:forEach items="${page.content}" var="page">
						<tr>
							...
							<td align="center">
								 ...
								 <a href='<c:url value="/admin/allies/announcement/edit/${page.id}"></c:url>'>修改</a>	
							</td>
						</tr>
					</c:forEach>
				</tbody>
...
<div class="modal hide fade" id="deleteAnnoPostModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-footer">
	    ...
	    <form action='<c:url value="/admin/allies/announcement/destory"></c:url>' method="post" style="display: inline-block;" >
