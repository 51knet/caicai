...
<div class="row-fluid custom round">
	...
	<div class="content">
		<form action= "<c:url value='/admin/allies/announcement/new'></c:url>"  method="post" name="anno_post" id="announcement_new_form"  enctype="multipart/form-data"  onsubmit="return checkPicture(this)">
