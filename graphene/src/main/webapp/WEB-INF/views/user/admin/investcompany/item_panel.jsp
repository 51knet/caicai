...
<div class="left-menu-container ">
	<ul class="nav  nav-stacked">
		...
		<li><a href='<c:url value="/admin/investcompany/announcement/list"></c:url>' >新闻动态</a></li>
		<li><a href='<c:url value="/admin/investcompany/successcase/list"></c:url>' >成功案例</a></li>
		<li><a href='<c:url value="/admin/investcompany/projects/list"></c:url>' >本站已投项目</a></li>
		<li><a href='<c:url value="/investcompany/${sessionUserInfo.id }"></c:url>' >机构前台页面</a></li>
