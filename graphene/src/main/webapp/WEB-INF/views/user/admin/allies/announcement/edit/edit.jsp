...
<div class="row-fluid custom round">
	...
	<div class="content">
		<form action= "<c:url value='/admin/allies/announcement/edit/edit'></c:url>"   method="post" name="anno_post" id="anno_new_form"   >
...
<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#anno_new_form").submit(function(){
				editor.sync();
				return checkEmptyAjax("anno_new_form","<c:url value='/admin/announcement/editAnnoInfoAJAX'></c:url>");
			});
			prettyPrint();
	    });
</script>