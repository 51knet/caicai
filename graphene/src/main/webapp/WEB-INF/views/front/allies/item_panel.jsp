...
<div class="cont_block">
	...
	<ul class="nav  nav-stacked">
		<li><a href='<c:url value="/front/allies/all"></c:url>' >全部成员</a></li>
		<li><a href='<c:url value="/front/allies/announcement/list"></c:url>' >联盟动态</a></li>
		<li><a href='<c:url value="/front"></c:url>' >网站首页</a></li>
	</ul>
 </div>
