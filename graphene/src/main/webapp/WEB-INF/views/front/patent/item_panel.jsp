...
<div class="cont_block">
	...
	<ul class="nav  nav-stacked">
		<li><a href='<c:url value="/front/patent/all"></c:url>' >全部专利</a></li>
		<li><a href='<c:url value="/front/patent/china"></c:url>'>国内专利</a></li>
		<li><a href='<c:url value="/front/patent/foreign"></c:url>' >国外专利</a></li>
	</ul>
 </div>
