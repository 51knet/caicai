...
<div class="left-menu-container">
	<ul class="nav nav-tabs nav-stacked">
		<li><a href='<c:url value="/admin/kefu/news/list"></c:url>' >新闻列表</a></li>
		<li><a href='<c:url value="/admin/kefu/activity/list"></c:url>' >动态列表</a></li>
	...
	<!-- <li><a href='<c:url value="/admin/kefu/applyright/all/all"></c:url>' >个人权限审核</a></li> -->	
		<li><a href='<c:url value="/admin/kefu/applyright/allies/all"></c:url>' >联盟权限审核</a></li>
		<li><a href='<c:url value="/admin/kefu/applyright/park/list"></c:url>' >园区审核</a></li>
	</ul>
</div>
