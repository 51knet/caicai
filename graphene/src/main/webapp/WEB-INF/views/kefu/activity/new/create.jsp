	...
	<div class="content">
		<form action= "<c:url value='/admin/kefu/activity/new'></c:url>" enctype="multipart/form-data"  method="post" name="activity_post" id="activity_new_form"  onsubmit="return checkPicture(this)" >
			<div class="control-group" id="title">
				<div class="controls">
					动态标题：<input type="text" name="title" placeholder="活动标题"> <span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group" id="content">
				...
				<div class="control-group" >
					<div class="controls">
						动态图片：<input type="file" name="coverFile" /><span style="font-size: 13px; color: red;">${errorMsg }</span>
