...
<div  class="cont_block">
	<div class="leftmenu_titles">
 		<img  src="<c:url value='/resources/img/default/exptitle.png' ></c:url>">
 	</div>
	...
	<ul class="nav  nav-stacked">
		<li><a href='<c:url value="/teacher/${userInfo.id}"></c:url>' >个人简历</a></li>
		<li><a href='<c:url value="/teacher/${userInfo.id}/patent/list"></c:url>' >专家专利</a></li>
		<li><a href='<c:url value="/teacher/${userInfo.id}/technology/list"></c:url>' >专家成果</a></li>
